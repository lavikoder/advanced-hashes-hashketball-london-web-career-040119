...
#primary gaol is learning how ruby iterates through the #nested hashes
#Below is the Data pproduced in the method gem_hash
...
def game_hash
 ...
 #the goal is to iterate through the hash to find the total_num of points scored
